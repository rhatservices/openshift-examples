...
- [Prometheus Example Queries](#prometheus-example-queries)
- [Cluster Metrics](#cluster-metrics)
    ...
    - [Cluster Disk I/O](#cluster-disk-io)
    - [Cluster Network Packets](#cluster-network-packets)
    - [Cluster Network I/O](#cluster-network-io)
- [Node Metrics](#node-metrics)
    ...
    - [Node Disk I/O](#node-disk-io)
    - [Node Network Packets](#node-network-packets)
    - [Node Network I/O](#node-network-io)
...
- [Workload Metrics](#workload-metrics)
    ...
    - [Workload Network I/O](#workload-network-io)
    - [Workload Disk I/O](#workload-disk-io)
